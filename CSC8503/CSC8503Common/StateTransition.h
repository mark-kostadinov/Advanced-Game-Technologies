...
namespace NCL
{
	namespace CSC8503
	{
		...
		public:
			...
			static bool GameObjectLessThanTransition(T dataA, U dataB) { return dataA->GetTransform().GetWorldPosition().x < dataB; }
			static bool GameObjectGreaterThanTransition(T dataA, U dataB) { return dataA->GetTransform().GetWorldPosition().x > dataB; }
