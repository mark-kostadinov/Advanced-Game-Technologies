...
GameTechRenderer::GameTechRenderer(GameWorld& world) : OGLRenderer(*Window::GetWindow()), gameWorld(world)	
{
	...
	lightColour = Vector4(1.0f, 1.0f, 0.9f, 1.0f);
...
void GameTechRenderer::RenderShadowMap() {
	...
	Matrix4 shadowProjMatrix = Matrix4::Perspective(2500.0f, 7000.0f, 1, 60.0f);
...
void GameTechRenderer::EnableAnisotropicFiltering(OGLTexture& texture, GLfloat anisotropyLevel)
{
